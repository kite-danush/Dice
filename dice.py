...
while logged_in1 == False:
    ...
    if username == 'danu' or username == 'User2' or username == 'User3' or username == 'User4' or username == 'User5':
...
while logged_in2 == False:
    username = input('What is your username? ')
    password = input('What is your password? ')
    if username == '' or username == 'User2' or username == 'User3' or username == 'User4' or username == 'User5':
